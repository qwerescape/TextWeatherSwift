...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: NSDictionary?) -> Bool {
        ...
        let defaultWeatherTexts = ["Hello you are in {location}, today's high is {high}, and today's low is {low}, and today's wind is {wind} and today's feel like is {current}",
        ...
        if NSUserDefaults.standardUserDefaults().objectForKey("AvailableTexts") == nil {
            ...
            NSUserDefaults.standardUserDefaults().setObject(defaultWeatherTexts[0], forKey: "UserText")
        }
        return true
    }
